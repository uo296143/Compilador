...
public class PmmParser extends Parser {
	...
	public static final int
		...
		RULE_block = 8, RULE_expression = 9, RULE_simple_type = 10, RULE_expressions = 11;
	...
	public final MainFunctionContext mainFunction() throws RecognitionException {
		...
		try {
			...
			setState(61);
			match(T__8);
			((MainFunctionContext)_localctx).ast =  new FunctionDefinition(_localctx.statements, new VariableDefinition(new FunctionType(new None(), new ArrayList<Statement>()), "main", ((MainFunctionContext)_localctx).MAIN.getLine(), ((MainFunctionContext)_localctx).MAIN.getCharPositionInLine()+1), ((MainFunctionContext)_localctx).MAIN.getLine(), ((MainFunctionContext)_localctx).MAIN.getCharPositionInLine()+1);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final FunctionDefinitionContext functionDefinition() throws RecognitionException {
		...
		try {
			...
			setState(121);
			match(T__8);
			((FunctionDefinitionContext)_localctx).ast =  new FunctionDefinition(_localctx.statements, new VariableDefinition(new FunctionType(_localctx.returnType, _localctx.functionParameters), (((FunctionDefinitionContext)_localctx).ID!=null?((FunctionDefinitionContext)_localctx).ID.getText():null), ((FunctionDefinitionContext)_localctx).ID.getLine(), ((FunctionDefinitionContext)_localctx).ID.getCharPositionInLine() + 1), ((FunctionDefinitionContext)_localctx).ID.getLine(), ((FunctionDefinitionContext)_localctx).ID.getCharPositionInLine() + 1);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
		...
		try {
			...
			case T__11:
				...
				while (_la==ID) {
					...
					setState(148);
					match(T__10);
					_localctx.fields.add(new Field((((TypeContext)_localctx).ID!=null?((TypeContext)_localctx).ID.getText():null), ((TypeContext)_localctx).t1.ast));
					}
					}
					setState(155);
					_errHandler.sync(this);
